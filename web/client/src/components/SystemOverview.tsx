    ...
    <div className="grid grid-cols-3 gap-6 mb-8">
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        ...
        <div className="space-y-3">
          ...
          {models?.routerModel === 'Local Lightweight' && (
            <div>
              <div className="text-sm text-gray-400">Local Lightweight</div>
              <ul className="text-xs text-gray-400 list-disc list-inside space-y-1">
                <li>Offline, zero‑cost local runtime</li>
                <li>No external AI calls; safe fallback</li>
                <li>Great for quick UI testing/demos</li>
              </ul>
            </div>
          )}
          <div>
